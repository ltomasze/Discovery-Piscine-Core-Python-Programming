...
Welcome to my repository! Here you will find a collection of solutions for the **Discovery Piscine** course, which focuses on learning the fundamentals of programming in Python. Each module introduces new concepts and reinforces the acquired knowledge through practical exercises.

## Repository Structure

The repository is divided into modules, each containing a series of exercises (`ex00`, `ex01`, etc.). The table below outlines the topics covered in each module.
...
<table>
  <thead>
    <tr>
      ...
      <th align="left">Main Topics</th>
      <th align="center">Link to Folder</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
Most scripts are designed to be run directly from the terminal.
...
2.  Run the script:
    ```bash
    ./path/to/your/file.py [arguments...]
    ```
